...
int main() {
    ...
    // Generate first process
    FILE *text_file = fopen("p1.txt", "w");
    FILE *binary_file = fopen("p1.proc", "wb");
    ...
    int code_size = 24;         // Code segment size (in bytes)
    int data_size = 96;         // Data segment size (in bytes)
    ...
    // Generate second process
    text_file = fopen("p2.txt", "w");
    binary_file = fopen("p2.proc", "wb");
    ...
    code_size = 48;         // Code segment size (in bytes)
    data_size = 64;         // Data segment size (in bytes)
    ...
    // Generate third process
    text_file = fopen("p3.txt", "w");
    binary_file = fopen("p3.proc", "wb");
    ...
    code_size = 32;         // Code segment size (in bytes)
    data_size = 128;        // Data segment size (in bytes)
    ...
    printf("Generated 3 process files: p1.proc, p2.proc, p3.proc\n");
    printf("Generated 3 text files: p1.txt, p2.txt, p3.txt\n");
